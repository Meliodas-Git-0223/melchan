...
def getdatamedia():
	...
	if tfile == "true":
		...
		if file.filename.split(".")[len(file.filename.split("."))-1] in videos:
			media = 'video'
		elif file.filename.split(".")[len(file.filename.split("."))-1] in images:
			media = 'image'
		elif file.filename.split(".")[len(file.filename.split("."))-1] in audio:
			media = 'audio'
